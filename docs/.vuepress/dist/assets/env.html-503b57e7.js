...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="部署时带固定前缀" tabindex="-1"><a class="header-anchor" href="#部署时带固定前缀" aria-hidden="true">#</a> 部署时带固定前缀</h3><p>例如访问路径需要调整为：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>http://pro.icelery.fun/cola/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>打包上传至服务器&amp;访问</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>http://pro.icelery.fun/cola/
